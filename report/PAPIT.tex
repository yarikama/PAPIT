...
\title{PAPIT: Prompt-Aware Pruning for Image Tokens\\
       ...
       \thanks{Code: \url{https://github.com/yarikama/PAPIT}}}
...
LLaVA-1.5-7B (\texttt{llava-hf/llava-1.5-7b-hf}\footnote{\url{https://huggingface.co/llava-hf/llava-1.5-7b-hf}})
at fp16, with its native CLIP ViT-L/14 vision tower
(\texttt{openai/clip-vit-large-patch14}\footnote{\url{https://huggingface.co/openai/clip-vit-large-patch14}})
